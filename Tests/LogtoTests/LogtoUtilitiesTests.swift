...
final class LogtoUtilitiesTests: XCTestCase {
    ...
    func testVerifyIdToken() throws {
        ...
        let idTokenHS256 = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
        ...
        XCTAssertThrowsError(try LogtoUtilities.verifyIdToken(idTokenHS256, issuer: "foo", clientId: "bar", publicKeys: [jwk])) {
            XCTAssertEqual($0 as? LogtoErrors.Verification, LogtoErrors.Verification.algorithmNotSupported)
        }
